...
export interface RemoveAllReminderAction {
  type: typeof REMOVE_ALL_REMINDERS,
  payload: DateObj
}
...
export type ReminderActionTypes = AddReminderAction | SetModalIsOpenAction
  | UpdateReminderAction | SelectReminderAction | SetSelectedDateAction
  | RemoveReminderAction | RemoveAllReminderAction
